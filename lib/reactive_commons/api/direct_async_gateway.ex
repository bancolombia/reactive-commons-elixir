defmodule DirectAsyncGateway do
  ...
  def request_reply(query = %AsyncQuery{}, target_name),
    do: request_reply(:app, query, target_name)
  ...
  def request_reply_wait(query = %AsyncQuery{}, target_name),
    do: request_reply_wait(:app, query, target_name)
  ...
  def send_command(command = %Command{}, target_name),
    do: send_command(:app, command, target_name)
